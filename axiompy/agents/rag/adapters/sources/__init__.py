...
# Always available
from axiompy.agents.rag.adapters.sources.filesystem import FileSystemSource
from axiompy.agents.rag.domain.ports import DocumentSource
    ...
    def create(
        ...
        match source_type:
            ...
            case SourceType.MOCK:
                from axiompy.agents.rag.adapters.mocks import MockDocumentSource
