...
from axiompy.agents.rag.adapters.vector_stores.memory import InMemoryVectorStore
...
class VectorStoreFactory:
    ...
    Example:
        from axiompy.agents.rag import VectorStoreType, VectorStoreSettings
    ...
    def create(
        ...
        from axiompy.agents.rag.adapters.mocks import MockVectorStore
        from axiompy.agents.rag.factory import VectorStoreType
